...
package com.lixiang.weather.support.database.util;
...
public class OtherUtils {
    ...
    public static boolean isSupportRange(final HttpResponse response) {
        ...
        org.apache.http.Header header = response.getFirstHeader("Accept-Ranges");
        if (header != null) {
    ...
    public static Charset getCharsetFromHttpRequest(final HttpRequestBase request) {
		...
		org.apache.http.Header header = request.getFirstHeader("Content-Type");
        if (header != null) {
            for (HeaderElement element : header.getElements()) {

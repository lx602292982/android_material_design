...
package com.lixiang.weather.support.database.db.table;
...
import com.lixiang.weather.support.database.db.annotation.Check;
import com.lixiang.weather.support.database.db.annotation.Column;
import com.lixiang.weather.support.database.db.annotation.Finder;
import com.lixiang.weather.support.database.db.annotation.Foreign;
import com.lixiang.weather.support.database.db.annotation.Id;
import com.lixiang.weather.support.database.db.annotation.NotNull;
import com.lixiang.weather.support.database.db.annotation.Transient;
import com.lixiang.weather.support.database.db.annotation.Unique;
import com.lixiang.weather.support.database.db.converter.ColumnConverter;
import com.lixiang.weather.support.database.db.converter.ColumnConverterFactory;
import com.lixiang.weather.support.database.db.sqlite.FinderLazyLoader;
import com.lixiang.weather.support.database.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.lixiang.weather.support.database.db.table.Foreign foreignColumn) {
    ...
    public static Class<?> getFinderTargetEntityType(com.lixiang.weather.support.database.db.table.Finder finderColumn) {

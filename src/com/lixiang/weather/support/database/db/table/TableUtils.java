...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.lixiang.weather.support.database.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.lixiang.weather.support.database.db.table.Id>();

    /* package */
    static synchronized com.lixiang.weather.support.database.db.table.Id getId(Class<?> entityType) {
        ...
        com.lixiang.weather.support.database.db.table.Id id = new com.lixiang.weather.support.database.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.lixiang.weather.support.database.db.table.Id id = getId(entityType);

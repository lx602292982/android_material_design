 ...
 */
package com.lixiang.weather.support.view.smarttab;
...
public class SmartTabLayout extends HorizontalScrollView {
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		if (tabStrip.isIndicatorAlwaysInCenter() && getChildCount() > 0) {
			...
			int right = (w - tabStrip
					.getChildMeasuredWidthAt(getChildCount() - 1)) / 2;
	...
	private void scrollToTab(int tabIndex, int positionOffset) {
		...
		if (selectedChild != null) {
			...
			if (tabStrip.isIndicatorAlwaysInCenter()) {
				targetScrollX -= (tabStrip.getChildWidthAt(0) - selectedChild
						.getWidth()) / 2;
